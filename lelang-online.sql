...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 17 Okt 2023 pada 18.24
...
CREATE TABLE `tb_barang` (
  ...
  `tanggal_awal` int(20) NOT NULL,
  `tanggal_akhir` int(20) NOT NULL,
...
INSERT INTO `tb_barang` (`id_barang`, `nama_barang`, `harga_awal`, `harga_akhir`, `deskripsi`, `tanggal_awal`, `tanggal_akhir`, `foto`, `status`, `bid`) VALUES
(1, 'coba-lelang', '1000', '2000', 'coba-lelang', 2023, 2023, '355asus-rog.jpg', 'dibuka', 1900),
(3, 'headphone razer', '2500', '3400', 'Headphone gaming terbaik', 2023, 2023, '5316headphone razer.jpeg', 'dibuka', 0),
(4, 'keyboard', '10000', '20000', 'keyboard gaming terbaik', 2023, 2023, '3893keyboard.jpg', 'dibuka', 0);
...
(1, 1, '2023-10-17', 0, 1, 2, 'dibuka'),
(3, 3, '2023-10-17', 0, 1, 2, 'dibuka'),
(4, 4, '2023-10-17', 0, 1, 2, 'dibuka');
...
INSERT INTO `tb_masyarakat` (`id_user`, `nama_lengkap`, `username`, `password`, `telepon`) VALUES
(1, 'rifqi maulana', 'rifqi', '72561baf6079c338cc2dd68e98d52055', '9090');
